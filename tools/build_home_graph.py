...
LESSON_CONCEPTS = {
    'P15-C01-S01': ['计算图', '标量神经元', '激活与损失', '静态表示'],
    'P15-C01-S02': ['链式法则', '反向累积', '差分核验', '训练与验证'],
    'P15-C02-S01': ['固定间隔映射', '一步预测', '非线性特征', '留出初值'],
    'P15-C02-S02': ['自由滚动', '多步损失', '轨迹划分', '模型失配'],
    'P15-C03-S01': ['连续右端', '解析解', '前向灵敏度', 'Euler 梯度'],
    'P15-C03-S02': ['伴随跳跃', '离散反传', '反向重建', '非线性修正'],
    'P15-C04-S01': ['平滑候选', '方程残差', '分项损失', '独立配点'],
    'P15-C04-S02': ['扩散模态', '无通量边界', '内部残差', '初值条件'],
    'P15-C05-S01': ['已知收支', '学习修正', '新输入预测', '零修正基线'],
    'P15-C05-S02': ['参数混淆', '额外观测', '预测矩', '结构可辨识'],
    'P16-C01-S01': ['非线性反馈', '能量下降', '三次项抵消', '充分条件'],
    'P16-C01-S02': ['输入饱和', '实际执行', '初值范围', '有限轨迹'],
    'P16-C02-S01': ['共同二次函数', '仿射顶点', '矩阵负定', '鲁棒范围'],
    'P16-C02-S02': ['集合外反例', '证书保守性', '适用边界', '执行约束'],
    'P16-C03-S01': ['递推最小二乘', '遗忘因子', '投影', '持续激励'],
    'P16-C03-S02': ['在线时序', '参数漂移', '跟踪误差', '输入限幅'],
    'P16-C04-S01': ['布朗增量', '随机离散', '路径配对', '解析矩'],
    'P16-C04-S02': ['随机风险', '经验分布', '越界频率', '统计误差'],
    'P16-C05-S01': ['局部一致性', '图拉普拉斯', '平均守恒', '连通分量'],
    'P16-C05-S02': ['通信延迟', '历史状态', '步长边界', '差异模态'],
    'P16-C06-S01': ['决策过程', '固定策略', 'Bellman 方程', '吸收态'],
    'P16-C06-S02': ['表格 Q 学习', '终止更新', '探索覆盖', '独立评估'],
    'P16-C07-S01': ['学习预测器', '有限动作', '预测可行', '失败状态'],
    'P16-C07-S02': ['配对测试', '预测误差', '实际违约', '迁移边界'],
    'P17-C01-S01': ['论文主张', '原文版本', 'Lorenz 条件', '课程缩减'],
    'P17-C01-S02': ['螺旋任务', '潜变量模型', '连续伴随', '改编边界'],
    'P17-C02-S01': ['候选字典', '阈值重拟合', '独立初态', '结构恢复'],
    'P17-C02-S02': ['伴随跳跃', '梯度核验', '机制基线', '独立外推'],
    'P17-C03-S01': ['稀疏消融', '导数噪声', '失效记录', '测试误差'],
    'P17-C03-S02': ['求解精度', '模型消融', '新初态', '数值边界'],
    'P17-C04-S01': ['双室清除', '交换守恒', '课程迁移', '共同观测'],
    'P17-C04-S02': ['配对比较', '收支残差', '失败率', '结论范围'],
