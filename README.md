...
- 全书按 17 篇、85 章规划；前十四篇的 69 章已交付，共 168 本正式 Notebook（含篇末综合）、57 个章节探索视图与 778 道练习。
- M0—M15 已完成；第 15—17 篇的 16 章为设计导览，下一步实施 M16《可微分建模与机制融合》。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)按目录顺序学习，当前已交付至[第 14 篇：数据驱动动力学与模型降阶](notebooks/14-数据驱动动力学与模型降阶/README.md)。启动本机程序后可打开[开始首页](http://127.0.0.1:8000/)或[全书目录](http://127.0.0.1:8000/catalog/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
