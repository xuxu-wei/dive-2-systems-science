...
- 全书按 17 篇、85 章规划；前十六篇的 81 章已交付，共 194 本正式 Notebook（含篇末综合）、69 个章节探索视图与 890 道练习。
- M0—M17 已完成；第 17 篇四章为设计导览，下一步实施 M18《研究复现与综合实践》。
...
在默认 IDE 中选择项目 `.venv` 作为 Notebook 内核，从[第 1 篇：看见系统](notebooks/01-看见系统/README.md)按目录顺序学习，当前已交付至[第 16 篇：自适应、鲁棒与学习控制](notebooks/16-自适应、鲁棒与学习控制/README.md)。启动本机程序后可打开[开始首页](http://127.0.0.1:8000/)或[全书目录](http://127.0.0.1:8000/catalog/)；环境、操作与故障处理见[学习指南](docs/学习指南.md)。
